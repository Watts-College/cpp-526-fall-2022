...
#### [CPP 526: Foundations of Data Science I](https://watts-college.github.io/cpp-526-fall-2022/)
...
[![](images/download.png)](https://github.com/Watts-College/cpp-526-fall-2022/blob/main/labs/cpp-526_reformatted-labs/Lab-02-LastName.zip?raw=true)
...
This lab uses [**city tax parcel data**](https://watts-college.github.io/cpp-526-fall-2022/labs/syr_parcels.html), and open dataset released by the municipal government of Syracuse, NY. 
...
NOTE: do not include `install.packages` commands in your RMD chunks. Trying to install packages while knitting can cause errors. 
...
#### [Data Dictionary](https://watts-college.github.io/cpp-526-fall-2022/labs/syr_parcels.html)
...
#### 1. Where are the majority of vacant lots located in downtown Syracuse? Produce a map of your results that matches the one shown here. 
...
> **sum()** with the **amtdelinqt** variable
...
#### 8. How many of each land use type are delinquent on taxes? Print a table of your results. 
...
**What is the total value of all of the commercial parcels in downtown Syracuse?**

**What is the total value of all of the non-commercial parcels in downtown Syracuse?**
...
# if we know that 200 people will visit the museum this weekend,
...
Missing values serve a very important function in statistics, because they force the analyst to decide whether we can ignore them completely, or whether the need to be interpreted if we want the model to be accurate. So when you get this: 

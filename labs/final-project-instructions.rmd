...
[![](images/download.png)](https://github.com/Watts-College/cpp-526-fall-2022/blob/main/labs/cpp-526_reformatted-projects/cpp-526-DashboardTemplates.zip?raw=true)
...
You will again use the traffic accidents dataset from the Tempe [Open Data Portal](https://data.tempe.gov/datasets/tempegov::1-08-crash-data-report-detail/about). The details of the dataset are reported at the end of these instructions. 
...
You will use the traffic accidents dataset (from the Tempe [Open Data Portal](https://data.tempe.gov/datasets/tempegov::1-08-crash-data-report-detail/about)) that was used in Lab 04 and Lab 05:  

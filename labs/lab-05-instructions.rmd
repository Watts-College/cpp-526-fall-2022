...
In this lab you will use a traffic accidents dataset from the Tempe [Open Data Portal](https://data.tempe.gov/datasets/tempegov::1-08-crash-data-report-detail/about):
...
[![](images/download.png)](https://github.com/Watts-College/cpp-526-fall-2022/blob/main/labs/cpp-526_reformatted-labs/Lab-05-LastName.zip?raw=true)
...
#### 1) How many accidents happened on Mondays?
...
plot( as.numeric(d2$hour), d2$n, pch=19, type="b", cex=2, bty="n",
      xlab="Hour of the Day", ylab="Total Number of Accidents", 
...
plot( as.numeric(d2$hour), d2$harm, pch=19, type="b", cex=2, bty="n",
      ...
      main="Proportion of Accidents that Result in Injuries or Fatalities")
...
plot( as.numeric(d2$hour), d2$ave.num.injuries, pch=19, type="b", cex=2, bty="n",
      xlab="Hour of the Day", ylab="Average Number of Passengers Hurt",
